  ...
  getInfo(): void {
    ...
    querySnapshot.then((snapshot) => {
      ...
      snapshot.forEach((docc) => {
        ...
        this.render(projectName, projectDescription, projectDueDate, projectMembers, projectId);        
      })
    })
  }


  render(name: string, description: string, dueDate: string, projectMembers : Object, id :string): void {
